describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize'" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("eOncay uponay aay imetay anday aay eryvay oodgay imetay itay asway erethay asway aay oocowmay omingcay ownday alongay ethay oadray anday isthay oocowmay atthay asway omingcay ownday alongay ethay oadray etmay aay icenay ittlelay oybay amednay abybay uckootay")
    end
  end
