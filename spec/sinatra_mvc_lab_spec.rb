describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize'" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("Oncay uponay a imetay anday a eryvay oodgay imetay it asway erethay asway a oocowmay omingcay ownday alongay ethay oadray anday isthay oocowmay atthay asway omingcay ownday alongay ethay oadray etmay a icensnay ittlelay oybay amednay abybay uckootay")
    end
  end
  ...
  describe "POST '/piglatinize' again" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("He asway an olday anmay owhay ishedfay alonay in a iffskay in ethay ulfGay eamStay anday he adhay onegay eightyay ourfay aysday ownay ithoutway akingtay a ishfay")
    end
  end
end