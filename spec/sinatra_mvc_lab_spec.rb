describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize' again" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("eHay asway an olday anmay owhay ishedfay aloneay in a iffskay in ethay ulfGay reamStay and ehay adhay onegay eightyay ourfay aysday ownay ithoutway akingtay a ishfay")
    end
  end
end