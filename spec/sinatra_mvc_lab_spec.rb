describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize'" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("Onceway uponway a imetay and a eryvay oodgay imetay itway asway erethay asway a oocowmay omingcay ownday alongway ethay oadray and isthay oocowmay atthay asway omingcay ownday alongway ethay oadray etmay a icensnay ittlelay oybay amednay abybay uckootay")
    end
  end
  ...
  describe "POST '/piglatinize' again" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("eHay asway an oldway anmay owhay ishedfay aloneway in a iffskay in ethay ulfGay eamStray and ehay adhay onegay eightyway ourfay aysday ownay ithoutway akingtay a ishfay")
    end
  end
end