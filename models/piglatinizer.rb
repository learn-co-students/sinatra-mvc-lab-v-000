class PigLatinizer
  ...
  def piglatinize(word)
    ...
    elsif @@consonants.include?(word[0].downcase) && @@consonants.include?(word[1].downcase) && @@consonants.include?(word[2].downcase) #if first, second, and third letter is a consonant
